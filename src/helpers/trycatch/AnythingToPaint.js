...
const AnythingTopaint = (elem, string) => {
  ...
  let strStyle1 =
    "background: #593800; color: #F5EBF5; font-size: 24px; font-family: Roboto; font-style: normal";
  let strStyle2 =
    "background: #593800; color: #E74752; font-size: 24px; font-family: Roboto; font-style: normal";
  let strStyle3 =
    "background: #593800; color: #626DF2; font-size: 24px; font-family: Roboto; font-style: normal";
  try {
    situation = true;
