...
const initCategory = (app, mainContent, state, imagesCategory, category, levelDetails) => {

  let replaceCategory = category.replace(/ ([a-z])/g, function (g) { return g[1].toUpperCase(); })
  ...
  CreateCategory(app, mainContent, imagesCategory, MODE, loaderVoice, category, levelDetails)
