...
import beautifyKeyPng from './beautifyKeyPng'


let fruit = []
fruit = importAll(require.context('../category/fruit', true, /\.png$/), fruit)
let vegetables = []
vegetables = importAll(require.context('../category/vegetables', true, /\.png$/), vegetables)

let transport = []
transport = importAll(require.context('../category/transport', true, /\.png$/), transport)

let pets = []
pets = importAll(require.context('../category/pets', true, /\.png$/), pets)

let wildAnimals = []
wildAnimals = importAll(require.context('../category/wildanimals', true, /\.png$/), wildAnimals)

let furniture = []
furniture = importAll(require.context('../category/furniture', true, /\.png$/), furniture)

let clothes = []
clothes = importAll(require.context('../category/clothes', true, /\.png$/), clothes)

let professions = []
professions = importAll(require.context('../category/professions', true, /\.png$/), professions)
